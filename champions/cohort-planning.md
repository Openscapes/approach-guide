...
## Partners Planning Kickoff Meeting {#partners-planning-call}
...
With a new partner community, the goal of the kickoff meeting is to build trust by giving them confidence in our approach (based on evidence!); we save introducing cohort structure, [Pre-Cohort Engagement](/champions/pre-cohort-engage.qmd), and onboarding any assistants for a later meeting.

...
We will add participants to this Google Folder prior to Call 1, and we'll add Agendas here the days before each Cohort Call. The idea is to avoid overloading people with information - give folks access at the right time.

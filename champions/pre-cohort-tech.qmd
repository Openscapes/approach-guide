...
## `Cohort Planning Checklist` GitHub Issue

We create a "Cohort Planning Checklist" GitHub Issue to help with our planning inside the Cohort GitHub repo. The Cohort Planning Checklist Issue tracks collective TODO's as a checklist and has "quick links" that are nice to have handy for planning and when leading Cohort Calls (the ParticipantsList is important for making team breakout rooms!). 

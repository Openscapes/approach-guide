...
Create a Cohort GitHub repo within the Openscapes GitHub organization or in the NMFS Openscapes GitHub organization for NOAA NMFS Cohorts (starting Fall 2022). An example repository looks like this: <https://github.com/Openscapes/2021-noaa-nmfs> or this <https://github.com/nmfs-openscapes/2022-noaa-nwfsc-fall>. Our convention has been that the repository name is the same as the **cohort_name** from the Cohort Registry above, example: `2021-noaa-nmfs`. To start, a Cohort repo should include a README and a Code of Conduct. This can be done with `kyber`, as described below, or by hand by copy-pasting a README from another cohort (we did this for the first 8 Champions cohorts!) and [Code of Conduct](https://raw.githubusercontent.com/Openscapes/website/main/content/code-of-conduct.md) from the Openscapes website repo.
...
-   Invite Cohort to join Slack
    ...
    -   Inside Slack \> Openscapes \> Invite people to Openscapes \> add list of email addresses. Invite as Member. Custom message (Copy this text exactly because URLs are not permitted in custom invitation message): "Please join us in Openscapes Slack. Here's some information in our Approach Guide to help you get comfortable (copy the url then remove the space after //): https:// openscapes.github.io/approach-guide/approach/tooling.html#slack."
        -   Custom invitation messages are limited to 560 characters and do not allow urls
        -   Sending the invite from inside Slack is preferable to creating an invitation link that gets sent in a separate email.
-   Write a welcome message in the #general channel: Hi Everyone - We have a new Champions Cohort that started today and we just added them to slack! They may say hello here too :wave: Here is their \[ cohort repo \] with a few more details.

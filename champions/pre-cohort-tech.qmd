...
WIP add bullet list with before Call 1, after Call 1 etc
...
- Create agenda 
- Email reminder to participants - day before
- Add participants to Cohort Folder - day before

### After Call 1

- Draft Field Notes (TODO add link to doc)
- Send Digest to participants via email, then copy to new GitHub Issue in Cohort repo (after Call 2, all digests are added to GitHub Issues only)
- Invite particpants to Slack
- Create Google Calendar invite for 4 coworking sessions (after Calls 1-4) in Openscapes Cohorts calendar. Set Google Meet co-hosts. Add participants as guests. 
...
![Checklist excerpt for GitHub repo and Cohort Google Folder](images/checklist-beforeCall1-github.png){fig-alt="screenshot of checklist excerpt" width="90%"}
...
To use `kyber`, you'll open RStudio on your computer ([instructions](/contributing/setup.qmd)). In the RStudio console, install the `kyber` library ([instructions](https://openscapes.github.io/kyber)) and follow the [configuration instructions](https://openscapes.github.io/kyber/#configuration). Browse the README to see what additional R packages you might need to install.

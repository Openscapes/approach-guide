...
<!---
Keep some of this text on kyber The general info was placed at top of this file/section
...
We can copy the [Example Cohort Setup Checklist Issue](#cohort-setup-checklist) into our new GitHub repo. Click the "copy-to-clipboard" icon and now you can paste it in a new GitHub issue and it will appear as a functional checklist. 

<!---
This text is from when checklist was not in markdown. Keep here till we've decided how it will remain

...and maintain the formatting as a checklist, on the far right of this page, click "Edit this page" beside the GitHub icon, copy all the checklist text (starts and ends with `:::`), and paste it in a new issue. Now we can edit the checklist text to suit our specific Cohort details.
--->

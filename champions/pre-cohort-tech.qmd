...
Slack can be a daunting new tool. That's why we send that welcoming invitation email that provides some background and links to guidance, rather than simply adding people's emails from inside Slack.

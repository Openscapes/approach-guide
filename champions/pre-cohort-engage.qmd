...
description text: Cohort Calls for the [2023 Fred Hutch Openscapes Champions Cohort](https://openscapes.github.io/2023-fred-hutch/)
Quicklinks: Shared Cohort Google Folder [Openscapes_CohortCalls [ 2023-fred-hutch ]](https://drive.google.com/drive/folders/1i-ZZRMvEHDwQ5vJZpX_P4ycqOTwAKnyM?usp=drive_link)
:::
...
We use Google Calendar Appointment Slots or the new Appointment Schedule to schedule these 1:1's \~1 month before the start of the cohort. ([Learn about appointment slots vs (new) schedules](https://support.google.com/calendar/answer/11608416). Note in early access preview of schedules, you can't add additional team members to your appointment schedule so that they're automatically added to booked appointments - must do that manually.) Create \~2 half-day blocks and invite team leads to book and invite their team members.
...
I'm following up on our conversation about your Data Strategies
lesson for the CA Water Boards Openscapes Cohort. Here's my advice
brain-dump ;-) 

The most important point is that you don't need to make up new material or create an activity. We teach these lessons from [our existing slide deck](https://docs.google.com/presentation/d/1WJzVMg1Ps2cHG0G6D5kpnL-OCJ-wVBILMqtmzDQxEgU/).
Julie taught from this deck to the previous Water Boards Cohort and I
did the same for another cohort. The speaker notes have some guiding
language. We try to basically say what's on the slides and we pepper
them (within the time limit) with personal examples or anecdotes. 

The[ Data Strategies page](https://openscapes.github.io/series/core-lessons/data-strategies.html)
in our Openscapes Champions Lesson Series, has a narrative that
essentially follows the slides. Near the top of that page is a link to a
recording of Ileana Fenwick teaching from the same slide deck. The
first time I prepared to give that lesson (the only time so far), I
started by watching Ileana's recording and reading the couple of papers/
blog posts in the slides. Tip: when a slide has a list of 10 tips, you
don't need to say them all. You might say "this paper gives 10 tips for
... . I want to highlight 3". Then I said the tip and gave an example of
how I've used it in my work. That's the way you get to make the same
slide deck be relatable and allow you to share your own knowledge and
experiences.

The Water Boards sessions are in
Microsoft Teams. There are \~ 20 folks. When teaching, you don't share
your screen - people follow along by clicking through the slide deck
themselves - that means it's easier to use speaker notes if you like to
do that. Anna Holder, the lead, is such a warm facilitator with a great
sense of humour that shows through. She makes for a really positive
teaching experience. 

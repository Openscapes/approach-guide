...
This is the POP (Purpose, Outcomes, Process) for Blog posts about Champions Cohorts, but these are also relevant for posts in general:

- **Purpose**: showcase awesome science teams and inspire more learning. Elevate Mentors. Amplify Mentors’ reflections in debriefs. Elevate Partners. Tie to bigger themes/reflections we’ve had, write down ideas, have a link to summarize events we’ve led (so we remember and can share), notes to ourselves about what we did differently. This will function as a cheat-sheet for everyone in the future about what we did, who was involved, why it was important, and what we were thinking.
- **Outcomes**: a short blog post, co-authored with Mentors and partners
- **Process**: See startegies below. “start in the action”, reuse structure, draw from digest and debrief notes; “good enough”. Include co-authors, invite feedback but no obligation to be a co-author.

### Blog strategies

Blog posts take time. A lot of time. And they often feel extra, especially in a culture of needing peer-reviewed publications. But they are super valuable, and important. So, along with a [Google Doc Template](https://docs.google.com/document/d/1DuyxqU6c262kyDVVdYeAXYkL1NUdPdcpnUP6Hkhk6Ec/edit?usp=sharing), here are some strategies we use to write blogs:
...
## Example text to email/Slack co-authors

Hello [coauthors]

Here's our Champions [blog post draft] for your opinionated edits. Please review the draft blog post by Date, or reply to say "I'm good - no comments". Direct edits are welcome. You will all be authors. Have we missed anyone who would like to co-author other than as a NASA Openscapes Mentors? We plan to publish on the Date.
...
See [Tooling / Zenodo](tooling.md#sec-zenodo) for technical details, including how we [Add Citation guidance to Openscapes materials](tooling.md#add-citation-guidance-to-openscapes-materials).

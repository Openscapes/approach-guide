...
3.  **Add a digital object identifier (DOI) so that it is citable**, for example by submitting to Zenodo. If the material is on GitHub, first make a Release, then see [How to get a DOI for materials on GitHub](/tooling.qmd#how-to-get-a-doi-for-materials-on-github).

...
This section describes how to get a DOI for a "research related digital artefact" like our online books on GitHub.
...
2.  **Store the material in a repository that allows us to publish it**, like GitHub.

3.  **Add a digital object identifier (DOI) so that it is citable.**

4.  **Add a "how to cite"** section to guide users. We like [Citing The Turing Way](https://the-turing-way.netlify.app/index.html#citing-the-turing-way) as an example to follow.

We follow [this how-to](https://www.metadocencia.org/en/post/compartirmaterialdoi/) by Yanina Bellini Saibene for Metadocencia. It's clear, has great annotated screenshots, and is also available in Spanish.

One thing to watch for when making a Release on GitHub is go to `/releases` e.g. <https://github.com/Openscapes/pathways-to-open-science/releases> to create a release because it doesn't appear on the right of repository page automatically.

TODO: add How to cite section to Lesson Series and NASA Earthdata Cookbook and any other products for which we get a DOI.

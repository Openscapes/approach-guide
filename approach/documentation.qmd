...
4.  **Add a "how to cite"** section to guide users; here's [how to cite](https://nasa-openscapes.github.io/earthdata-cloud-cookbook/#citation) the NASA Earthdata Cloud Cookbook. We like [Citing The Turing Way](https://the-turing-way.netlify.app/index.html#citing-the-turing-way) as an example to follow.

...
*   [dataquest Teams FAQ](https://support.dataquest.io/en/categories/18-teams-faq)
*   $283 / license / year
*   Learners and helpers were given licenses
*   Julie is the account ownder, Andy and Ileana were admins
*   Email `teams@dataquest.io` with anything; they’ll get back to us in 24 hours
*   They will be create a custom path with the two paths (R Basics \+ Visualization) 
*   Chandra AI for help (in lower left as working through courses)  
*   Community forum  
*   API to download metrics on learners for reporting  
*   Added a voice screenreader to courses, rolling out over the next six weeks
...
*   Added learners via csv upload, once all in, email `teams@dataquest.io` to get licenses added, we were sent the invoice. They turned off auto-renewal.
...
Participants have access to the full dataquest.io library of courses in addition to the R Curriculum. We recommend the following additional courses for those who had extra capacity:
...
*	Wednesdays not great for help desk
*	Help Desk walkthough recordings
*	break week

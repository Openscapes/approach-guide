...
[![Openscapes flywheel shows 6 points around a hexagon: Develop, Invest, Attract, Deliver, Transform, Inspire](images/openscapes-flywheel.png){fig.alt="Openscapes flywheel shows 6 points around a hexagon: Develop, Invest, Attract, Deliver, Transform, Inspire. There are three phases incorporated into the Flywheel. Phase 1: Engage = Develop, Invest and Attract; Phase 2: Empower = Deliver and Transform; Phase 3: Amplify = Inspire.  The 6 points around the Openscapes flywheel include:  Develop Champions Mentors - professional development and leadership skills;  Invest in Champions Program curriculum; Attract teams interested in better practices for data-intensive science;  Deliver Champions Program for a Cohort of teams;  Transform teams workflows towards kinder, inclusive open science;  Inspire broader scientific communities through visible examples and leaders - Open science shift."}](https://openscapes.org)
